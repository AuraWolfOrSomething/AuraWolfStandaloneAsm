...
.type CanUnitBeUndeployed, %function
		...
		@Display error message (this is copied from trying to deploy a unit when the cannot deploy state bit is set)
		ldrh	r1, [r5,#0x2E]
		mov		r2, #1
		and		r2, r1
		lsl		r0, r2, #3
		...
		sub		r1, r2
		add		r1, #0x18
		ldr		r2, =MinDeployUndeployDenyTextLink
		ldrh	r2, [r2]
		mov		r3, r5
		blh		PrepUnitSelectCallHelpBox, r4
